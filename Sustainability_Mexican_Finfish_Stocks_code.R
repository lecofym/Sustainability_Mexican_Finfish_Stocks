...
list.of.packages <- c("R2jags","coda","parallel","foreach","doParallel","gplots","randtests","randtests","neuralnet","conicfit")
...
################################################################################
# De snpar se usa una prueba de aleatoriedad basada en rachas (runs.test)
# Se cambia por la misma prueba de aleatoriedad pero de la biblioteca randtests


#Instalar desde el código fuente
#install.packages("/Users/Yosspy/Downloads/JAGS-4.3.2", repos = NULL, type="source")
...
#-----------------------------------------
catch_file  <- "Catch_GC_2023.csv" #"Stocks_Catch_2020CMSYrun2_v5_RS - Copy.csv"  #"CombStocks_Catch_2020CMSYrun3_v4.csv"  # "SAUP_Catch_1.csv"  #"SimCatchCPUE_4.csv"  # "Stocks_Catch_Aust_2.csv" #"STECF_Catch_2020_2.csv" #"tRFMO_Catch_2020.csv" #"ICES_Catch_2020.csv" #"Global_Stocks_Catch.csv" #"SimCatchCPUE_4.csv" #"Stocks_Catch_Test.csv"  #"Stock_Catch_forRainer.csv" # "SimCatchCPUE_3.csv" #  name of file containing "Stock", "yr", "ct", and optional "bt"
id_file     <- "ID_GC_2023.csv" #"Stocks_ID_forDeng_RSb - Copy.csv" # "CombStocks_ID_2020CMSYrun3_v3_RF3.csv"   #    "SAUP_ID_2.csv"    #"SimSpecCPUE_4_NA_int_end.csv"  #"Train_ID_7j.csv" # "Stocks_ID_Aust_4.csv"  #"STECF_ID_2020_2.csv" #tRFMO_ID_2020_2.csv" #"ICES_ID_2020_4.csv" #"Robust_Stocks_ID_10_allNA.csv" #"SimSpecCPUE_4.csv"#"Stocks_ID_R_7.csv"  #"Stock_ID_forRainer.csv"  #  "NCod_ID_4.csv" #"SimSpecCPUE_3.csv" #  name of file containing stock-specific info and settings for the analysis
...
rk.diags     <- F #><>MSY set to TRUE to plot diagnostic plot for r-k space
...
bsm   <- function(ct,btj,nyr,prior.r,prior.k,startbio,q.priorj,
  ...
  jags_outputs <- jags.parallel(data=jags.data,
                                working.directory="C:/Users/Yosspy/AppData/Roaming/Microsoft/Windows/Start Menu/Programs/CSMY_Resultados", inits=j.inits,
  ...
  if(BSMfits.plot==T & FullSchaefer==T & force.cmsy==F){
    ...
    runs.sig3 <- function(x,type="resid") {
      ...
      if(nlevels(factor(sign(x)))>1){
        runstest = randtests::runs.test(resid)
